...
class ElectionsFragment: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        viewModel.getUpComingElection().observe(viewLifecycleOwner, Observer { elections ->
            elections?.apply {
                upcomingElectionListAdapter.elections = elections
            }
        })

        viewModel.getSavedElectionList().observe(viewLifecycleOwner, Observer { elections ->
            elections?.apply {
